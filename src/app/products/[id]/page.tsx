    ...
    return (
        <div className='bg-white'>
            <div className='container mx-auto '>
                ...
                <div className="grid grid-cols-1 md:px-0 px-3 md:grid-cols-2 gap-5  py-6">
                    ...
                    <div className='flex items-center justify-center '>
                        ...
                        <div className='flex flex-col gap-3 sm:gap-10 md:w-[80%] '>
                            ...
                            <div className='p-1 px-3 w-fit text-white bg-[#029FAE] rounded flex gap-2 items-center text-lg'>
                                <svg
                                    width="22"
                                    height="22"
                                    viewBox="0 0 22 22"
